...
export const DICT = {
  ...
  "machine.folderBody": {
    en: "The full path of a folder on that machine. Fylane there reaches that folder and nothing above it, the same as here.",
    zh: "那台机器上目录的完整路径。那边的 Fylane 只碰这个目录,不碰它的上层,和本机一样。",
  },
  "machine.fieldPath": { en: "Path", zh: "路径" },
  "machine.fieldPathPlaceholder": { en: "/home/you/project", zh: "/home/you/project" },
