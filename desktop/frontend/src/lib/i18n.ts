...
export const DICT = {
  ...
  "machine.addTitle": { en: "Add a remote machine", zh: "添加远程机器" },
  "machine.addBody": {
    en: "Fylane connects with the ssh on this computer. Key-based login to the machine must already work from a terminal; nothing here asks for a password.",
    zh: "Fylane 用这台电脑上的 ssh 连过去。要先能在终端里用密钥免密登录那台机器;这里不会问密码。",
  },
  "machine.fieldName": { en: "Name", zh: "名称" },
  "machine.fieldNamePlaceholder": { en: "vps-1", zh: "vps-1" },
  "machine.fieldHost": { en: "Host", zh: "主机" },
  "machine.fieldHostPlaceholder": {
    en: "203.0.113.5, vps.example.com, or an ssh config alias",
    zh: "203.0.113.5、vps.example.com,或 ssh config 里的别名",
  },
  "machine.fieldUser": { en: "User (optional)", zh: "用户(可选)" },
  "machine.fieldPort": { en: "Port (optional)", zh: "端口(可选)" },
  "machine.addAction": { en: "Add", zh: "添加" },
