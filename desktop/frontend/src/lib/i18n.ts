...
export const DICT = {
  ...
  "machine.connecting": { en: "Connecting…", zh: "连接中…" },
  "machine.missing": { en: "Fylane is not installed", zh: "没有安装 Fylane" },
  "machine.outdated": { en: "Fylane needs updating", zh: "Fylane 需要更新" },
  "machine.installing": { en: "Installing…", zh: "安装中…" },
  "machine.starting": { en: "Starting…", zh: "启动中…" },
  "machine.off": { en: "Disconnected", zh: "已断开" },
  "machine.error": { en: "Not reachable", zh: "连不上" },
  "machine.unanswered": { en: "Not answering", zh: "没有回应" },
  "machine.install": { en: "Install Fylane", zh: "安装 Fylane" },
  "machine.update": { en: "Update Fylane", zh: "更新 Fylane" },
  "machine.reconnect": { en: "Reconnect", zh: "重新连接" },
  "machine.disconnect": { en: "Disconnect", zh: "断开" },
  "machine.remove": { en: "Remove", zh: "移除" },
  "machine.removeAsk": { en: "Remove?", zh: "确定移除?" },
  "machine.edit": { en: "Edit", zh: "修改" },
  "machine.sheetEyebrow": { en: "REMOTE MACHINE", zh: "远程机器" },
  "machine.addTitle": { en: "Bring a machine in", zh: "接一台远程机器进来" },
  "machine.editTitle": { en: "Change how {name} is reached", zh: "改一下怎么连 {name}" },
  "machine.addBody": {
    en: "Write it the way you type it after ssh. Your keys, known_hosts and ssh config apply as they are; nothing here asks for a password.",
    zh: "照你平时在 ssh 后面敲的写。密钥、known_hosts、ssh config 都照旧;这里不会问密码。",
  },
  ...
  "machine.answeredRunning": {
    ...
    zh: "{target} 应答了 · Fylane {version} 正在运行",
  },
  "machine.answeredInstalled": {
    en: "{target} answered · Fylane {version} is installed; it starts when you bring it in",
    zh: "{target} 应答了 · 装了 Fylane {version},接进来后会自动拉起",
  },
  "machine.answeredBare": {
    en: "{target} answered · no Fylane yet; one click installs it once it is in",
    zh: "{target} 应答了 · 还没有 Fylane,接进来后一键安装",
  },
  "machine.answeredOld": {
    en: "{target} answered · it runs Fylane {version}; you can update it once it is in",
    zh: "{target} 应答了 · 那边是 Fylane {version},接进来后可以更新",
  },
  "machine.reason.host_key": {
    en: "Not in known_hosts yet. ssh to it once from a terminal, then try again.",
    zh: "这台机器还不在 known_hosts 里。先在终端里 ssh 一次,再试。",
  },
  "machine.reason.auth": {
    en: "It refused the login. Key-based ssh has to work first; there is no password prompt here.",
    zh: "对方拒绝了登录。要先能用密钥免密 ssh 上去;这里不会问密码。",
  },
  ...
  "machine.folderTitle": { en: "Grant a folder on {name}", zh: "授权 {name} 上的目录" },
  "machine.fieldPath": { en: "Folder to grant", zh: "要授权的目录" },
  "machine.fieldPathPlaceholder": { en: "~/project", zh: "~/project" },
  "machine.browseReading": { en: "Asking the machine…", zh: "正在问那台机器…" },
  "machine.browseTyping": { en: "Checking that path…", zh: "正在确认这个路径…" },
  "machine.browseNoDir": {
    en: "There is no such folder on that machine.",
    zh: "那台机器上没有这个目录。",
  },
  "machine.browseDenied": {
    en: "That folder cannot be entered with this login.",
    zh: "这个登录进不去那个目录。",
  },
  "machine.browseEmpty": {
    en: "Nothing inside. This folder itself can be granted.",
    zh: "里面没有目录了。可以直接授权这个目录。",
  },
  "machine.browseDirs_one": { en: "{n} folder inside", zh: "里面有 {n} 个目录" },
  "machine.browseDirs_other": { en: "{n} folders inside", zh: "里面有 {n} 个目录" },
  "machine.browseShowHidden": { en: "show {n} hidden", zh: "显示 {n} 个隐藏的" },
  "machine.browseHideHidden": { en: "hide dot folders", zh: "收起隐藏的" },
  "machine.browseHome": { en: "home", zh: "回主目录" },
  "machine.browseUp": { en: "Up one level", zh: "上一级" },
  "machine.browseRepo": { en: "git", zh: "git" },
  "machine.browseType": { en: "type a path", zh: "手动输入" },
  "machine.browseTypeDone": { en: "done typing", zh: "收起" },
  "machine.folderAction": { en: "Grant", zh: "授权" },
  "machine.noFolder": { en: "No folder granted on {name}", zh: "{name} 上还没有授权目录" },
  "shell.errMachine": { en: "Could not change the machine list", zh: "机器列表没有改成功" },
  "shell.errMachineFolder": { en: "Could not grant that folder", zh: "没能授权那个目录" },
  ...
  "memory.counts": {
    en: "{live} notes, {archived} archived",
    zh: "{live} 条笔记,{archived} 条已归档",
  },
  "memory.rewroteBy": {
    en: "{who} rewrote the page {ago}",
    zh: "{who} {ago}改写了状态页",
  },
  "memory.you": { en: "You", zh: "你" },
  "memory.onMachine": { en: "on {machine}", zh: "存在 {machine} 上" },
  "memory.search": { en: "Search notes", zh: "搜笔记" },
  "memory.notes": { en: "Notes", zh: "笔记" },
  "memory.archived": { en: "Archived", zh: "已归档" },
  "memory.export": { en: "Export Markdown", zh: "导出 Markdown" },
  "memory.exported": { en: "Exported", zh: "已导出" },
  "memory.clear": { en: "Clear memory", zh: "清空记忆" },
  "memory.clearAsk": {
    en: "Delete the page and all {n} notes?",
    zh: "删掉状态页和全部 {n} 条笔记?",
  },
  "memory.clearConfirm": { en: "Clear", zh: "清空" },
  "memory.cancel": { en: "Cancel", zh: "取消" },
  "memory.stateHead": { en: "CURRENT STATE", zh: "当前状态" },
  "memory.stateNote": {
    en: "Rewritten whole by the AI; you can edit it here",
    zh: "由 AI 整页改写,你可以直接改",
  },
  "memory.goal": { en: "Goal", zh: "目标" },
  "memory.progress": { en: "Progress", zh: "进展" },
  "memory.next": { en: "Next", zh: "下一步" },
  "memory.decisions": { en: "Decisions made", zh: "已定的决定" },
  "memory.open": { en: "Open questions", zh: "待定的问题" },
  "memory.viewAll": { en: "View all", zh: "查看全部" },
  "memory.edit": { en: "Edit", zh: "编辑" },
  "memory.close": { en: "Close", zh: "关闭" },
  "memory.save": { en: "Save", zh: "保存" },
  "memory.emptyField": { en: "Nothing yet", zh: "还没有内容" },
  "memory.listHint": { en: "One item per line", zh: "一行一条" },
  "memory.tooLong": { en: "Over the limit of {n} bytes", zh: "超过 {n} 字节的上限" },
  "memory.tooManyItems": { en: "At most {n} items", zh: "最多 {n} 条" },
  "memory.itemTooLong": { en: "An item is over {n} bytes", zh: "有一条超过 {n} 字节" },
  "memory.results": { en: "RESULTS", zh: "搜索结果" },
  "memory.noResults": { en: "No note matches.", zh: "没有匹配的笔记。" },
  "memory.noArchived": { en: "Nothing has been archived yet.", zh: "还没有归档的笔记。" },
  "memory.noNotes": { en: "No notes yet.", zh: "还没有笔记。" },
  "memory.loadMore": { en: "Earlier notes", zh: "更早的笔记" },
  "memory.yesterday": { en: "Yest.", zh: "昨天" },
  "memory.summaryMeta": { en: "summary", zh: "摘要" },
  "memory.changeSet": { en: "change set", zh: "变更集" },
  "memory.setMeta": { en: "change set · {count}", zh: "变更集 {count}" },
  "memory.hChangeSet": { en: "CHANGE SET", zh: "变更集" },
  "memory.files": { en: "{count} · {file}", zh: "{count} · {file}" },
  "memory.filesAndMore": { en: "{count} · {file} and more", zh: "{count} · {file} 等" },
  "memory.undoUntil": { en: "undo until {time}", zh: "可撤销至 {time}" },
  "memory.recordGone": { en: "record cleared", zh: "记录已清理" },
  "memory.delete": { en: "Delete this note", zh: "删除这条" },
  "memory.emptyTitle": { en: "Nothing remembered yet", zh: "还没有记忆" },
  "memory.emptyBody": {
    en: "While the AI works in this folder it writes down where it got to and what was decided, and the next conversation picks up from here. It writes on its own; you can edit and delete here.",
    zh: "AI 在这个目录里工作时,会把做到哪、定了什么写在这里,下一次对话从这里接着开始。它自己会写;你也可以在这里改和删。",
  },
  "memory.emptyHow": { en: "How the AI takes notes", zh: "怎么让 AI 记笔记" },
  "memory.noFolderBody": {
    en: "Grant a folder on the lane first; what the AI remembers about it lives here.",
