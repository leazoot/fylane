...
export const DICT = {
  ...
  "machine.folderBody": {
    en: "Step into the folder you want, or type its path. Fylane there reaches that folder and nothing above it, the same as here.",
    zh: "一层层点进想要的目录,或者直接输路径。那边的 Fylane 只碰这个目录,不碰它的上层,和本机一样。",
  },
